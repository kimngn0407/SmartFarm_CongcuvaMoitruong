...
const createCrop = (data) => axios.post('/api/crops', data, { headers: getAuthHeader() });
...
// Growth Stage APIs
const createGrowthStage = (data) => axios.post('/api/growth-stages', data, { headers: getAuthHeader() });
